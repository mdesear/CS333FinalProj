...
class TestIntegration(unittest.TestCase):
    ...
    def test_fcfs(self, mock_print):
        ...
        test_avgTurnaround, test_taTimes = average.AverageTurnaround(test_completeTimes, 
                                                                      test_arrivals)
        test_pidOrder = []
        ...
        self.assertEqual(mock_print.mock_calls, [call("\nPID ORDER OF EXECUTION\n"),
                                                 ...
                                                 call("Average Process Turnaround Time: " +
                                                      '%.2f' % test_avgTurnaround + "\n"),
                                                 call("Average Process Wait Time: " + '%.2f' 
                                                     % test_avgWait + "\n")])
    ...
    def test_priority(self, mock_print):
        ...
        self.assertEqual(mock_print.mock_calls, [call("\nPID ORDER OF EXECUTION\n"),
                                                 ...
                                                 call(str(test_pidOrder[2])),
                                                 call(str(test_pidOrder[3])),
                                                 call("Average Processes Turnaround Time: " +
                                                      '%.2f' % test_avgTurnaround + "\n"),
                                                 call("Average Processes Wait Time: " + '%.2f' 
                                                     % test_avgWait + "\n")])
